...
const ArticleList = () => {
    ...
    return (
        <div className={styles.wrapper}>
            <div className={`headline ${styles.headline_wrapper}`}>
                <svg d="1641322160168" className="icon" viewBox="0 0 1024 1024"
                    ...
                    <path
                        ...
                        fill="var(--main-font-color)" p-id="7971"></path>
                    <path
                        ...
                        fill="var(--main-font-color)" p-id="7972"></path>
                    <path
                        ...
                        fill="var(--main-font-color)" p-id="7973"></path>
                </svg>
                <h6 className="headline-font">文章列表</h6>
            </div>
                        ...
                        return (
                            <li className={styles.article_item}>
                                <div className={styles.cover_wrapper}
                                    ...
                                    <svg d="1641374652392" className="icon"
                                        ...
                                        <path
                                            ...
                                            fill="var(--default-white)" p-id="9512"></path>
                                        <path
                                            ...
                                            fill="var(--default-white)" p-id="9513"></path>
                                        <path
                                            ...
                                            fill="var(--default-white)" p-id="9514"></path>
                                        <path
                                            ...
                                            fill="var(--default-white)" p-id="9515"></path>
                                    </svg>
                                    {/*<LazyLoad*/}
                                ...
                                <div className={styles.metadata_wrapper}
                                     onClick={() => window.open(`/posts/1`)}>
                                    <div className={styles.title_wrapper}><h1>title</h1></div>
                                    <div className={styles.intro_wrapper}><p>intro</p></div>
                                    <div className={styles.stats_wrapper}>
                                        ...
                                        {/*<div className={styles.cate_box} dangerouslySetInnerHTML={{*/}
